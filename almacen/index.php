                           ...
                           <div class="table table-responsive">
                               <table id="example1" class="table table-bordered table-striped table-sm">
                                   ...
                                   foreach ($productos_datos as $productos_dato){
                                       ...
                                       <tr>
                                           <td><center><?php echo $contador = $contador + 1; ?></td>
                                           <td><center><?php echo $productos_dato['codigo'];?></td>
                                           <td><center><?php echo $productos_dato['categoria'];?></td>
                                           <td><center>
                                               <img src="<?php echo $URL."/almacen/img_productos/".$productos_dato['imagen'];?>" width="50px" alt="asdf">
                                           </td>
                                           <td><center><?php echo $productos_dato['nombre'];?></td>
                                           ...
                                           <td><center><?php echo $productos_dato['precio_compra'];?></td>
                                           <td><center><?php echo $productos_dato['precio_venta'];?></td>
                                           <td><center><?php echo $productos_dato['fecha_ingreso'];?></td>
